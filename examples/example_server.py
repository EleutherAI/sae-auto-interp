...
with open(
    "/mnt/ssd-1/gpaulo/SAE-Zoology/extras/neuronpedia/formatted_contexts/activating_contexts_16k/mlp/0/layer_0_contexts_chunk_1.json",
    "r",
) as f:
    ...
    if score_type == "embedding":
        ...
        data = {
            "activations": activations[
                10:
            ],  # Using only the other activations for testing
            "explanation": explanation,
            "api_key": API_KEY,
            "model": MODEL,
            "type": score_type,
