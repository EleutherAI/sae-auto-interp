...
for layer in layers:
    ...
    for record in tqdm(records):
        try:
            ...
            top_20_explanation = load_explanation("saved_explanations/gpt2_top_20",record.feature)["result"]
            top_40_explanation = load_explanation("saved_explanations/gpt2_top_40",record.feature)["result"]
            random_10_explanation = load_explanation("saved_explanations/gpt2_random_10",record.feature)["result"]
            random_20_explanation = load_explanation("saved_explanations/gpt2_random_20",record.feature)["result"]
            random_40_explanation = load_explanation("saved_explanations/gpt2_random_40",record.feature)["result"]
            random_top_200_20_explanation = load_explanation("saved_explanations/gpt2_random_top_200_20",record.feature)["result"]
            random_top_200_40_explanation = load_explanation("saved_explanations/gpt2_random_top_200_40",record.feature)["result"]
...
output_dir = "scores/gpt2_random_10"
asyncio.run(
    execute_model(
        scorer, 
        random_10_explainer_inputs,
...
output_dir = "scores/gpt2_random_20"
asyncio.run(
    execute_model(
        scorer, 
        random_20_explainer_inputs,
...
output_dir = "scores/gpt2_random_40"
asyncio.run(
    execute_model(
        scorer, 
        random_40_explainer_inputs,
...
output_dir = "scores/gpt2_random_top_200_20"
asyncio.run(
    execute_model(
        scorer, 
        random_top_200_20_explainer_inputs,
...
output_dir = "scores/gpt2_random_top_200_40"
asyncio.run(
    execute_model(
        scorer, 
        random_top_200_40_explainer_inputs,
...
output_dir = "scores/gpt2_split_top_200_20_all_20"
asyncio.run(
    execute_model(
        scorer, 
        split_top_200_20_all_20_explainer_inputs,
