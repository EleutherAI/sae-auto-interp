...
#    explainers = [SimpleExplainer(**model_init_kwargs)]
    scorers = [DetectionScorer(**model_init_kwargs, test_model_dir=TEST_MODEL_DIR)]
...
if __name__ == "__main__":
    ...
    test_model = LanguageModel(TEST_MODEL_DIR, device_map="cpu", dispatch=True)
    ...
    for ae, records in feature_loader(tokens, features, test_model, ae_dict, offline=True):
        #stats.refresh(W_dec=ae.autoencoder.decoder.weight)
