...
raw_features_path = "raw_features_gpt_nora"
processed_features_path = "processed_features_gpt_nora"
...
for layer in layers:
    ...
    for record in tqdm(records):
        try:
            split_top_200_20_all_20_explanation = load_explanation("saved_explanations/gpt2_nora",record.feature)["result"]
