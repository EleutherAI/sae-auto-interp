...
scorer = FuzzingScorer(client,model.tokenizer, batch_size=1,echo=False,n_few_shots=5)


output_dir = "scores/gpt2_batch"
asyncio.run(
    execute_model(
        scorer, 
        split_top_200_20_all_20_explainer_inputs,
...
scorer = FuzzingScorer(client,model.tokenizer, batch_size=2,echo=False,n_few_shots=5)


output_dir = "scores/gpt2_batch_2"
asyncio.run(
    execute_model(
        scorer, 
        split_top_200_20_all_20_explainer_inputs,
...
output_dir = "scores/gpt2_batch_5"
asyncio.run(
    execute_model(
        scorer, 
        split_top_200_20_all_20_explainer_inputs,
...
scorer = FuzzingScorer(client,model.tokenizer,batch_size=10,echo=False,n_few_shots=5)


output_dir = "scores/gpt2_batch_10"
asyncio.run(
    execute_model(
        scorer, 
        split_top_200_20_all_20_explainer_inputs,
