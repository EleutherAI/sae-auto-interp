...
for layer in [24]:
    ...
    for record in tqdm(records):
        try:
            simple_explanation = load_explanation("saved_explanations/llamav2_simple",record.feature)["result"]
            activation_explanation = load_explanation("saved_explanations/llamav2_activation",record.feature)["result"]
            logit_explanation = load_explanation("saved_explanations/llamav2_logit",record.feature)["result"]
            cot_explanation = load_explanation("saved_explanations/llamav2_cot",record.feature)["result"]
...
output_dir = "scores/llamav2_simple"
asyncio.run(
    execute_model(
        scorer, 
        simple_inputs,
...
output_dir = "scores/llamav2_logit"
asyncio.run(
    execute_model(
        scorer, 
        logit_inputs,
...
output_dir = "scores/llamav2_activation"
asyncio.run(
    execute_model(
        scorer, 
        activation_inputs,
