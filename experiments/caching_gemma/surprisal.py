...
def main(args):
    ...
    def scorer_postprocess(result, score_dir):
        with open(f"results/scores/{sae_model}/{experiment_name}/{score_dir}/{result.record.feature}.txt", "wb") as f:
            f.write(orjson.dumps(result.score))

    os.makedirs(f"results/scores/{sae_model}/{experiment_name}/surprisal", exist_ok=True)
